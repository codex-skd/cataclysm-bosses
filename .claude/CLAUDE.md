# CLAUDE.md — the_sundering (26.2)

Este repositorio es un mod NeoForge del grupo `stalking-dragons/minecraft`.

## Workflow del mod

1. **Trabaja con `docs/WORKFLOW_THE_SUNDERING_26-2.md`** — es el workflow operativo de este mod, autocontenido. Léelo y síguelo. No hay que actualizarlo por sesión.
...
3. Workflow del proyecto (`docs/WORKFLOW_THE_SUNDERING_26-2.md`).
