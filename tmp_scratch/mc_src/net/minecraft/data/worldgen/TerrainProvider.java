...
public class TerrainProvider {
    ...
    private static <I extends BoundedFloatFunction<?>> CubicSpline<I> buildErosionJaggednessSpline(
        ...
        Float2FloatFunction jaggednessTransformer
    ) {
    ...
    private static <I extends BoundedFloatFunction<?>> CubicSpline<I> buildRidgeJaggednessSpline(
        I weirdness, I ridges, float jaggednessFactorAtPeakRidge, float jaggednessFactorAtHighRidge, Float2FloatFunction jaggednessTransformer
    ) {
    ...
    private static <I extends BoundedFloatFunction<?>> CubicSpline<I> buildWeirdnessJaggednessSpline(
        I weirdness, float jaggednessFactor, Float2FloatFunction jaggednessTransformer
    ) {
    ...
    private static <I extends BoundedFloatFunction<?>> CubicSpline<I> getErosionFactor(
        I erosion, I weirdness, I ridges, float baseValue, boolean shatteredTerrain, Float2FloatFunction factorTransformer
    ) {
        ...
        if (shatteredTerrain) {
            ...
            CubicSpline<I> extremeHillsTerrainFromMidSliceAndUp = CubicSpline.<I>builder(ridges, factorTransformer)
                ...
                .build();
            CubicSpline<I> extra3dNoiseOnPeaksOnly = CubicSpline.<I>builder(ridges, factorTransformer)
    ...
    private static <I extends BoundedFloatFunction<?>> CubicSpline<I> buildMountainRidgeSplineWithPoints(
        I ridges, float modulation, boolean saddle, Float2FloatFunction offsetTransformer
    ) {
    ...
    public static <I extends BoundedFloatFunction<?>> CubicSpline<I> buildErosionOffsetSpline(
        ...
        boolean saddle,
        Float2FloatFunction offsetTransformer
    ) {
        float lowPeaks = 0.6F;
    ...
    private static <I extends BoundedFloatFunction<?>> CubicSpline<I> ridgeSpline(
        I ridges, float valley, float low, float mid, float high, float peaks, float minValleySteepness, Float2FloatFunction offsetTransformer
    ) {
