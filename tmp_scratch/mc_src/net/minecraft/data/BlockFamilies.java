...
public class BlockFamilies {
    ...
    public static final BlockFamily CHERRY_PLANKS = familyBuilder(Blocks.CHERRY_PLANKS)
        ...
        .hangingSign(Blocks.CHERRY_HANGING_SIGN, Blocks.CHERRY_WALL_HANGING_SIGN)
    ...
    public static final BlockFamily BIRCH_PLANKS = familyBuilder(Blocks.BIRCH_PLANKS)
        ...
        .hangingSign(Blocks.BIRCH_HANGING_SIGN, Blocks.BIRCH_WALL_HANGING_SIGN)
    ...
    public static final BlockFamily CRIMSON_PLANKS = familyBuilder(Blocks.CRIMSON_PLANKS)
        ...
        .hangingSign(Blocks.CRIMSON_HANGING_SIGN, Blocks.CRIMSON_WALL_HANGING_SIGN)
    ...
    public static final BlockFamily JUNGLE_PLANKS = familyBuilder(Blocks.JUNGLE_PLANKS)
        ...
        .hangingSign(Blocks.JUNGLE_HANGING_SIGN, Blocks.JUNGLE_WALL_HANGING_SIGN)
    ...
    public static final BlockFamily OAK_PLANKS = familyBuilder(Blocks.OAK_PLANKS)
        ...
        .hangingSign(Blocks.OAK_HANGING_SIGN, Blocks.OAK_WALL_HANGING_SIGN)
    ...
    public static final BlockFamily DARK_OAK_PLANKS = familyBuilder(Blocks.DARK_OAK_PLANKS)
        ...
        .hangingSign(Blocks.DARK_OAK_HANGING_SIGN, Blocks.DARK_OAK_WALL_HANGING_SIGN)
    ...
    public static final BlockFamily SPRUCE_PLANKS = familyBuilder(Blocks.SPRUCE_PLANKS)
        ...
        .hangingSign(Blocks.SPRUCE_HANGING_SIGN, Blocks.SPRUCE_WALL_HANGING_SIGN)
    ...
    public static final BlockFamily WARPED_PLANKS = familyBuilder(Blocks.WARPED_PLANKS)
        ...
        .hangingSign(Blocks.WARPED_HANGING_SIGN, Blocks.WARPED_WALL_HANGING_SIGN)
    ...
    public static final BlockFamily BAMBOO_PLANKS = familyBuilder(Blocks.BAMBOO_PLANKS)
        ...
        .customHangingSign(Blocks.BAMBOO_HANGING_SIGN, Blocks.BAMBOO_WALL_HANGING_SIGN)
    ...
    public static final BlockFamily MOSSY_STONE_BRICKS = familyBuilder(Blocks.MOSSY_STONE_BRICKS)
        ...
        .generateStonecutterRecipe()
        .getFamily();
    public static final WeatheringCopperCollection<BlockFamily> CUT_COPPER = WeatheringCopperCollection.createFamily(
        (prefix, state) -> familyBuilder(Blocks.CUT_COPPER.waxed().pick(state))
            .slab(Blocks.CUT_COPPER_SLAB.waxed().pick(state))
            .stairs(Blocks.CUT_COPPER_STAIRS.waxed().pick(state))
            .recipeGroupPrefix(prefix + "cut_copper")
            .dontGenerateModel()
            .generateStonecutterRecipe()
            .getFamily(),
        (var0, state) -> familyBuilder(Blocks.CUT_COPPER.weathering().pick(state))
            .slab(Blocks.CUT_COPPER_SLAB.weathering().pick(state))
            .stairs(Blocks.CUT_COPPER_STAIRS.weathering().pick(state))
            .chiseled(Blocks.CHISELED_COPPER.weathering().pick(state))
            .dontGenerateModel()
            .generateStonecutterRecipe()
            .getFamily()
    );
    public static final WeatheringCopperCollection<BlockFamily> COPPER_BLOCK = WeatheringCopperCollection.createFamily(
        (prefix, state) -> familyBuilder(Blocks.COPPER_BLOCK.waxed().pick(state))
            .cut(Blocks.CUT_COPPER.waxed().pick(state))
            .recipeGroupPrefix(prefix + "cut_copper")
            .dontGenerateModel()
            .getFamily(),
        (var0, state) -> familyBuilder(Blocks.COPPER_BLOCK.weathering().pick(state))
            .cut(Blocks.CUT_COPPER.weathering().pick(state))
            .dontGenerateModel()
            .getFamily()
    );
    ...
    public static final BlockFamily GRANITE = familyBuilder(Blocks.GRANITE)
        ...
        .generateStonecutterRecipe()
        .getFamily();
    public static final BlockFamily SULFUR = familyBuilder(Blocks.SULFUR)
        .wall(Blocks.SULFUR_WALL)
        .stairs(Blocks.SULFUR_STAIRS)
        .slab(Blocks.SULFUR_SLAB)
        .chiseled(Blocks.CHISELED_SULFUR)
        .polished(Blocks.POLISHED_SULFUR)
        .generateStonecutterRecipe()
        .getFamily();
    public static final BlockFamily POLISHED_SULFUR = familyBuilder(Blocks.POLISHED_SULFUR)
        .wall(Blocks.POLISHED_SULFUR_WALL)
        .stairs(Blocks.POLISHED_SULFUR_STAIRS)
        .slab(Blocks.POLISHED_SULFUR_SLAB)
        .bricks(Blocks.SULFUR_BRICKS)
        .generateStonecutterRecipe()
        .getFamily();
    public static final BlockFamily SULFUR_BRICKS = familyBuilder(Blocks.SULFUR_BRICKS)
        .wall(Blocks.SULFUR_BRICK_WALL)
        .stairs(Blocks.SULFUR_BRICK_STAIRS)
        .slab(Blocks.SULFUR_BRICK_SLAB)
        .generateStonecutterRecipe()
        .getFamily();
    public static final BlockFamily CINNABAR = familyBuilder(Blocks.CINNABAR)
        .wall(Blocks.CINNABAR_WALL)
        .stairs(Blocks.CINNABAR_STAIRS)
        .slab(Blocks.CINNABAR_SLAB)
        .chiseled(Blocks.CHISELED_CINNABAR)
        .polished(Blocks.POLISHED_CINNABAR)
        .generateStonecutterRecipe()
        .getFamily();
    public static final BlockFamily POLISHED_CINNABAR = familyBuilder(Blocks.POLISHED_CINNABAR)
        .wall(Blocks.POLISHED_CINNABAR_WALL)
        .stairs(Blocks.POLISHED_CINNABAR_STAIRS)
        .slab(Blocks.POLISHED_CINNABAR_SLAB)
        .bricks(Blocks.CINNABAR_BRICKS)
        .generateStonecutterRecipe()
        .getFamily();
    public static final BlockFamily CINNABAR_BRICKS = familyBuilder(Blocks.CINNABAR_BRICKS)
        .wall(Blocks.CINNABAR_BRICK_WALL)
        .stairs(Blocks.CINNABAR_BRICK_STAIRS)
        .slab(Blocks.CINNABAR_BRICK_SLAB)
        .generateStonecutterRecipe()
        .getFamily();
