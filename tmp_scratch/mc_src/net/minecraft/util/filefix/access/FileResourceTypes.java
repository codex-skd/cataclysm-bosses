...
public class FileResourceTypes {
    ...
    public static FileResourceType<SavedDataNbt> savedData(TypeReference type) {
        return savedData(type, CompressedNbt.MissingSeverity.NEUTRAL);
    }

    public static FileResourceType<SavedDataNbt> savedData(TypeReference type, CompressedNbt.MissingSeverity missingSeverity) {
