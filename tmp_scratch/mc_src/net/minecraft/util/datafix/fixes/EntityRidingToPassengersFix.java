...
public class EntityRidingToPassengersFix extends DataFix {
    ...
    private static <Entity, EntityTree> Pair<String, Pair<Either<List<EntityTree>, Unit>, Entity>> addPassengerToTop(
        Pair<String, Pair<Either<List<EntityTree>, Unit>, Entity>> root,
        Entity passengerEntity,
        DynamicOps<?> ops,
        Type<EntityTree> rawEntityTreeType,
        OpticFinder<Pair<String, Pair<Either<List<EntityTree>, Unit>, Entity>>> entityTreeFinder
    ) {
