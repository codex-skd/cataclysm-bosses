...
public class ItemIdFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        Type<Either<Integer, Pair<String, String>>> oldItemType = DSL.or(
        ...
        return this.fixTypeEverywhereTyped(
            ...
            itemStack -> itemStack.update(id, newItemType, oldId -> oldId.map(l -> Pair.of(References.ITEM_NAME.typeName(), getItem(l)), r -> r))
        );
    }
}
