...
public final class OptionInstance<T> {
    ...
    public static OptionInstance<Boolean> createBoolean(
        String captionId, boolean initialValue, OptionInstance.ValueUpdateListener<? super Boolean> onValueUpdate
    ) {
    ...
    public OptionInstance(
        ...
        T initialValue,
        OptionInstance.ValueUpdateListener<? super T> onValueUpdate
    ) {
    ...
    public interface CycleableValueSet<T> extends OptionInstance.ValueSet<T> {
        ...
        default Function<OptionInstance<T>, AbstractWidget> createButton(
            OptionInstance.TooltipSupplier<T> tooltip, Options options, int x, int y, int width, OptionInstance.ValueUpdateListener<? super T> onValueChanged
        ) {
    ...
    public static final class OptionInstanceSliderButton<N> extends AbstractOptionSliderButton implements ResettableOptionWidget {
        ...
        private OptionInstanceSliderButton(
            ...
            OptionInstance.ValueUpdateListener<? super N> onValueChanged,
