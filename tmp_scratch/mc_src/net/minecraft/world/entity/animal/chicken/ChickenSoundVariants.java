...
public class ChickenSoundVariants {
    ...
    private static ResourceKey<ChickenSoundVariant> createKey(ChickenSoundVariants.SoundSet chickenSoundVariant) {
    ...
    private static void register(
        BootstrapContext<ChickenSoundVariant> context, ResourceKey<ChickenSoundVariant> key, ChickenSoundVariants.SoundSet ChickenSoundVariant
    ) {
