...
public class PigSoundVariants {
    ...
    private static ResourceKey<PigSoundVariant> createKey(PigSoundVariants.SoundSet pigSoundVariant) {
    ...
    private static void register(BootstrapContext<PigSoundVariant> context, ResourceKey<PigSoundVariant> key, PigSoundVariants.SoundSet PigSoundVariant) {
    ...
    public enum SoundSet {
        ...
        SoundSet(String identifier, String soundEventIdentifier) {
