...
public class InteractWithDoor {
    ...
    public static void closeDoorsThatIHaveOpenedOrPassedThrough(
        ServerLevel level,
        LivingEntity body,
        @Nullable Node movingFromNode,
        @Nullable Node movingToNode,
        Set<GlobalPos> doors,
    ...
    private static Optional<Set<GlobalPos>> rememberDoorToClose(
        MemoryAccessor<Mu, Set<GlobalPos>> doorsMemory, Optional<Set<GlobalPos>> doors, ServerLevel level, BlockPos doorPos
    ) {
