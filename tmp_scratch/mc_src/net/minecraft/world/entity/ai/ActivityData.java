...
public record ActivityData<E extends LivingEntity>(
    ...
    public static <E extends LivingEntity> ActivityData<E> create(
        Activity activity, int priorityOfFirstBehavior, ImmutableList<? extends BehaviorControl<? super E>> behaviorList
    ) {
    ...
    public static <E extends LivingEntity> ActivityData<E> create(
        Activity activity,
        int priorityOfFirstBehavior,
        ImmutableList<? extends BehaviorControl<? super E>> behaviorList,
        MemoryModuleType<?> memoryThatMustHaveValueAndWillBeErasedAfter
    ) {
    ...
    public static <E extends LivingEntity> ActivityData<E> create(
        Activity activity, ImmutableList<? extends Pair<Integer, ? extends BehaviorControl<? super E>>> behaviorPriorityPairs
    ) {
    ...
    public static <E extends LivingEntity> ImmutableList<? extends Pair<Integer, ? extends BehaviorControl<? super E>>> createPriorityPairs(
        int priorityOfFirstBehavior, ImmutableList<? extends BehaviorControl<? super E>> behaviorList
    ) {
