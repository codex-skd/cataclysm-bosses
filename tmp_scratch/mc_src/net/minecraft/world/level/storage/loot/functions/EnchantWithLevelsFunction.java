...
public class EnchantWithLevelsFunction extends LootItemConditionalFunction {
    ...
    private EnchantWithLevelsFunction(
        List<LootItemCondition> predicates, NumberProvider levels, Optional<HolderSet<Enchantment>> options, boolean includeAdditionalCostComponent
    ) {
        super(predicates);
        this.levels = levels;
    ...
    public static class Builder extends LootItemConditionalFunction.Builder<EnchantWithLevelsFunction.Builder> {
        ...
        public EnchantWithLevelsFunction.Builder withOptions(HolderSet<Enchantment> tag) {
            this.options = Optional.of(tag);
            return this;
        }

        public EnchantWithLevelsFunction.Builder withOptions(Optional<HolderSet<Enchantment>> options) {
            this.options = options;
            return this;
        }
