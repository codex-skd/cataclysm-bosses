...
public class TrialSpawnerConfigs {
    ...
    private static <T extends Entity> SpawnData customSpawnDataWithEquipment(
        EntityType<T> type, Consumer<CompoundTag> tagModifier, @Nullable ResourceKey<LootTable> equipmentLootTable
    ) {
    ...
    private static void register(
        BootstrapContext<TrialSpawnerConfig> context, TrialSpawnerConfigs.Keys keys, TrialSpawnerConfig normalConfig, TrialSpawnerConfig ominousConfig
    ) {
