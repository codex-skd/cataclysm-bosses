...
public class EndSpikeFeature extends Feature<EndSpikeConfiguration> {
    ...
    private void placeSpike(ServerLevelAccessor level, RandomSource random, EndSpikeConfiguration config, EndSpikeFeature.EndSpike spike) {
    ...
    private static class SpikeCacheLoader extends CacheLoader<Long, List<EndSpikeFeature.EndSpike>> {
        public List<EndSpikeFeature.EndSpike> load(Long seed) {
