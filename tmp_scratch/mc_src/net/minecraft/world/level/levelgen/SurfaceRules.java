...
public class SurfaceRules {
    ...
    @SafeVarargs
    public static SurfaceRules.ConditionSource isBiome(HolderGetter<Biome> biomes, ResourceKey<Biome>... target) {
        return new SurfaceRules.BiomeConditionSource(HolderSet.direct(biomes::getOrThrow, target));
    }

    public static SurfaceRules.ConditionSource noiseCondition2d(ResourceKey<NormalNoise.NoiseParameters> noise, double minRange) {
        return noiseCondition2d(noise, minRange, Double.MAX_VALUE);
    }

    public static SurfaceRules.ConditionSource noiseCondition2d(ResourceKey<NormalNoise.NoiseParameters> noise, double minRange, double maxRange) {
