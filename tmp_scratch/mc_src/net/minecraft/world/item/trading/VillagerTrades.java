...
public class VillagerTrades {
    ...
    private static void registerWanderingTraderTerracottaSellTrades(
        BootstrapContext<VillagerTrade> context, ColorCollection<ResourceKey<VillagerTrade>> trades, ColorCollection<Item> items
    ) {
        ColorCollection.zipApply(
            trades,
            items,
    ...
    private static VillagerTrade createCartographerBannerSell(
        HolderGetter<VillagerType> villagerVariants, Item item, List<ResourceKey<VillagerType>> villagerTypes
    ) {
        return new VillagerTrade(
            new TradeCost(Items.EMERALD, 2),
    ...
    private static void registerBasicExplorerMapTrades(
        BootstrapContext<VillagerTrade> context, HolderGetter<Item> items, HolderGetter<VillagerType> villagerVariants
    ) {
        register(
            context,
