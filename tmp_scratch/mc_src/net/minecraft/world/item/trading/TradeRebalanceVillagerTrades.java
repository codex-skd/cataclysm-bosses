...
public class TradeRebalanceVillagerTrades extends VillagerTrades {
    ...
    private static VillagerTrade createLibrarianLevel1EnchantmentTrade(
        HolderGetter<Item> items, HolderSet<Enchantment> doubleTradePrice, HolderSet<VillagerType> villagerTypes, HolderSet<Enchantment> enchantments
    ) {
    ...
    private static VillagerTrade createLibrarianLevel5EnchantmentTrade(
        HolderGetter<Item> items, HolderSet<Enchantment> doubleTradePrice, HolderSet<VillagerType> villagerTypes, Holder<Enchantment> enchantment, int level
    ) {
        return new VillagerTrade(
    ...
    private static VillagerTrade createLibrarianLevel5SpecialEnchantmentTrade(
        HolderGetter<Item> items, HolderSet<Enchantment> doubleTradePrice, HolderSet<VillagerType> villagerTypes, Holder<Enchantment> enchantment
    ) {
        return new VillagerTrade(
            new TradeCost(Items.EMERALD, 0),
            Optional.of(new TradeCost(Items.BOOK, 1)),
