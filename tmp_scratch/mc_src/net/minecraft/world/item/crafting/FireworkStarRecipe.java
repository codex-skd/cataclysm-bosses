...
public class FireworkStarRecipe extends CustomRecipe {
    ...
    public FireworkStarRecipe(
        Map<FireworkExplosion.Shape, Ingredient> shapes, Ingredient trail, Ingredient twinkle, Ingredient fuel, Ingredient dye, ItemStackTemplate result
    ) {
        this.shapes = shapes;
        this.trail = trail;
    ...
    private FireworkExplosion.@Nullable Shape findShape(ItemStack itemStack) {
