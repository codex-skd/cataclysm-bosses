...
public interface SlotDisplay {
    ...
    private static <T> Stream<T> applyDemoTransformation(
        ContextMap context,
        DisplayContentsFactory<T> factory,
        SlotDisplay firstDisplay,
        SlotDisplay secondDisplay,
        RandomSource randomSource,
        BinaryOperator<ItemStack> operation
    ) {
    ...
    private static <T> Stream<T> applyDemoTransformation(
        ContextMap context, DisplayContentsFactory<T> factory, SlotDisplay firstDisplay, SlotDisplay secondDisplay, BinaryOperator<ItemStack> operation
    ) {
        if (factory instanceof DisplayContentsFactory.ForStacks<T> stacks) {
            List<ItemStack> firstItems = firstDisplay.resolveForStacks(context);
            if (firstItems.isEmpty()) {
