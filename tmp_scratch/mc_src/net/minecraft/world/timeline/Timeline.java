...
public class Timeline {
    ...
    private Timeline(
        ...
        Map<EnvironmentAttribute<?>, AttributeTrack<?, ?>> tracks,
        Map<ResourceKey<ClockTimeMarker>, Timeline.TimeMarkerInfo> timeMarkers
    ) {
        this.clock = clock;
    ...
    public static class Builder {
        ...
        public Timeline.Builder addTimeMarker(ResourceKey<ClockTimeMarker> id, int ticks) {
