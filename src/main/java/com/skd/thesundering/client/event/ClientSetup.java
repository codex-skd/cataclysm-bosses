...
import com.skd.thesundering.client.gui.GUIWeponfusion;
...
import com.skd.thesundering.client.particle.AfterImageParticle;
import com.skd.thesundering.client.particle.Amethyst_Crush_Particle;
import com.skd.thesundering.client.particle.CircleLightningParticle;
import com.skd.thesundering.client.particle.Circle_Particle;
import com.skd.thesundering.client.particle.CursedAlgizParticle;
import com.skd.thesundering.client.particle.CursedFlameParticle;
import com.skd.thesundering.client.particle.CursedMarkParticle;
import com.skd.thesundering.client.particle.CustomExplodeParticle;
import com.skd.thesundering.client.particle.Custom_Poof_Particle;
import com.skd.thesundering.client.particle.Desert_Glyph_Particle;
import com.skd.thesundering.client.particle.Dust_Blast_Particle;
import com.skd.thesundering.client.particle.EM_PulseParticle;
import com.skd.thesundering.client.particle.FlameJetParticle;
import com.skd.thesundering.client.particle.Gathering_Water_Particle;
import com.skd.thesundering.client.particle.Ignis_Soul_Swing_Particle;
import com.skd.thesundering.client.particle.Ignis_Swing_Particle;
import com.skd.thesundering.client.particle.LightTrailParticle;
import com.skd.thesundering.client.particle.LightningExplodeParticle;
import com.skd.thesundering.client.particle.LightningParticle;
import com.skd.thesundering.client.particle.LightningStormParticle;
import com.skd.thesundering.client.particle.Lightning_Zap_Particle;
import com.skd.thesundering.client.particle.Not_Spin_TrailParticle;
import com.skd.thesundering.client.particle.ParryParticle;
import com.skd.thesundering.client.particle.Phantom_Emitter_Particle;
import com.skd.thesundering.client.particle.Phantom_Wing_FlameParticle;
import com.skd.thesundering.client.particle.RainCloudParticle;
import com.skd.thesundering.client.particle.Rain_Fog_Particle;
import com.skd.thesundering.client.particle.RingParticle;
import com.skd.thesundering.client.particle.Rising_Trail_Particle;
import com.skd.thesundering.client.particle.RoarParticle;
import com.skd.thesundering.client.particle.Scylla_Swing_Particle;
import com.skd.thesundering.client.particle.Shock_WaveParticle;
import com.skd.thesundering.client.particle.SoulLavaParticle;
import com.skd.thesundering.client.particle.SparkParticle;
import com.skd.thesundering.client.particle.SparkTrailParticle;
import com.skd.thesundering.client.particle.SpinTrailParticle;
import com.skd.thesundering.client.particle.StormParticle;
import com.skd.thesundering.client.particle.TrackLightningParticle;
import com.skd.thesundering.client.particle.TrapFlameParticle;
import com.skd.thesundering.client.render.CMItemstackRenderer;
import com.skd.thesundering.client.render.blockentity.Boss_Respawn_Spawn_Renderer;
import com.skd.thesundering.client.render.blockentity.Cursed_Tombstone_Renderer;
import com.skd.thesundering.client.render.blockentity.Door_Of_Seal_Renderer;
import com.skd.thesundering.client.render.blockentity.Goddess_Statue_Renderer;
import com.skd.thesundering.client.render.blockentity.RendererAbyssal_Egg;
import com.skd.thesundering.client.render.blockentity.RendererAltar_of_Abyss;
import com.skd.thesundering.client.render.blockentity.RendererAltar_of_Amethyst;
import com.skd.thesundering.client.render.blockentity.RendererAltar_of_Fire;
import com.skd.thesundering.client.render.blockentity.RendererAltar_of_Void;
import com.skd.thesundering.client.render.blockentity.RendererEMP;
import com.skd.thesundering.client.render.blockentity.RendererMechanical_fusion_anvil;
import com.skd.thesundering.client.render.entity.Abyss_Blast_Portal_Renderer;
import com.skd.thesundering.client.render.entity.Abyss_Blast_Renderer;
import com.skd.thesundering.client.render.entity.Abyss_Mark_Renderer;
import com.skd.thesundering.client.render.entity.Abyss_Mine_Renderer;
import com.skd.thesundering.client.render.entity.Abyss_Orb_Renderer;
import com.skd.thesundering.client.render.entity.Abyss_Portal_Renderer;
import com.skd.thesundering.client.render.entity.Accretion_Renderer;
import com.skd.thesundering.client.render.entity.Amethyst_Cluster_Projectile_Renderer;
import com.skd.thesundering.client.render.entity.Amethyst_Crab_Renderer;
import com.skd.thesundering.client.render.entity.Ancient_Desert_Stele_Renderer;
import com.skd.thesundering.client.render.entity.Ancient_Remnant_Rework_Renderer;
import com.skd.thesundering.client.render.entity.Aptrgangr_Renderer;
import com.skd.thesundering.client.render.entity.Axe_Blade_Renderer;
import com.skd.thesundering.client.render.entity.Blazing_Bone_Renderer;
import com.skd.thesundering.client.render.entity.Boltstrike_Renderer;
import com.skd.thesundering.client.render.entity.Brontes_Renderer;
import com.skd.thesundering.client.render.entity.Cindaria_Renderer;
import com.skd.thesundering.client.render.entity.Clawdian_Renderer;
import com.skd.thesundering.client.render.entity.Cm_Falling_Block_Renderer;
import com.skd.thesundering.client.render.entity.Coral_Golem_Renderer;
import com.skd.thesundering.client.render.entity.Coralssus_Renderer;
import com.skd.thesundering.client.render.entity.Cursed_Sandstorm_Renderer;
import com.skd.thesundering.client.render.entity.Death_Laser_beam_Renderer;
import com.skd.thesundering.client.render.entity.Deepling_Angler_Renderer;
import com.skd.thesundering.client.render.entity.Deepling_Brute_Renderer;
import com.skd.thesundering.client.render.entity.Deepling_Priest_Renderer;
import com.skd.thesundering.client.render.entity.Deepling_Renderer;
import com.skd.thesundering.client.render.entity.Deepling_Warlock_Renderer;
import com.skd.thesundering.client.render.entity.Dimensional_Rift_Renderer;
import com.skd.thesundering.client.render.entity.Draugr_Renderer;
import com.skd.thesundering.client.render.entity.Drowned_Host_Renderer;
import com.skd.thesundering.client.render.entity.Elite_Draugr_Renderer;
import com.skd.thesundering.client.render.entity.Ender_Golem_Renderer;
import com.skd.thesundering.client.render.entity.Ender_Guardian_Renderer;
import com.skd.thesundering.client.render.entity.Ender_Guardian_bullet_Renderer;
import com.skd.thesundering.client.render.entity.Endermaptera_Renderer;
import com.skd.thesundering.client.render.entity.Eye_Of_Dungeon_Renderer;
import com.skd.thesundering.client.render.entity.Flame_Strike_Renderer;
import com.skd.thesundering.client.render.entity.Flare_Bomb_Renderer;
import com.skd.thesundering.client.render.entity.Hippocamtus_Renderer;
import com.skd.thesundering.client.render.entity.Ignis_Abyss_Fireball_Renderer;
import com.skd.thesundering.client.render.entity.Ignis_Fireball_Renderer;
import com.skd.thesundering.client.render.entity.Ignis_Renderer;
import com.skd.thesundering.client.render.entity.Ignited_Berserker_Renderer;
import com.skd.thesundering.client.render.entity.Ignited_Revenant_Renderer;
import com.skd.thesundering.client.render.entity.Kobolediator_Renderer;
import com.skd.thesundering.client.render.entity.Koboleton_Renderer;
import com.skd.thesundering.client.render.entity.Laser_Beam_Renderer;
import com.skd.thesundering.client.render.entity.Lava_Bomb_Renderer;
import com.skd.thesundering.client.render.entity.Lightning_Spear_Renderer;
import com.skd.thesundering.client.render.entity.Lionfish_Renderer;
import com.skd.thesundering.client.render.entity.Lionfish_Spike_Renderer;
import com.skd.thesundering.client.render.entity.Maledictus_Renderer;
import com.skd.thesundering.client.render.entity.Mini_Abyss_Blast_Renderer;
import com.skd.thesundering.client.render.entity.Modern_Remnant_Renderer;
...
import com.skd.thesundering.client.render.entity.Octo_Ink_Renderer;
import com.skd.thesundering.client.render.entity.Phantom_Arrow_Renderer;
import com.skd.thesundering.client.render.entity.Phantom_Halberd_Renderer;
import com.skd.thesundering.client.render.entity.Player_Ceraunus_Renderer;
import com.skd.thesundering.client.render.entity.Poison_Dart_Renderer;
import com.skd.thesundering.client.render.entity.Portal_Abyss_Blast_Renderer;
import com.skd.thesundering.client.render.entity.RendererNull;
import com.skd.thesundering.client.render.entity.Royal_Draugr_Renderer;
import com.skd.thesundering.client.render.entity.Sandstorm_Projectile_Renderer;
import com.skd.thesundering.client.render.entity.Sandstorm_Renderer;
import com.skd.thesundering.client.render.entity.Scylla_Ceraunus_Renderer;
import com.skd.thesundering.client.render.entity.Scylla_Renderer;
import com.skd.thesundering.client.render.entity.Storm_Serpent_Renderer;
import com.skd.thesundering.client.render.entity.Symbiocto_Renderer;
import com.skd.thesundering.client.render.entity.The_Baby_Leviathan_Renderer;
import com.skd.thesundering.client.render.entity.The_Harbinger_Renderer;
import com.skd.thesundering.client.render.entity.The_Leviathan_Renderer;
import com.skd.thesundering.client.render.entity.The_Prowler_Renderer;
import com.skd.thesundering.client.render.entity.The_Watcher_Renderer;
import com.skd.thesundering.client.render.entity.Thrown_Coral_Bardiche_Renderer;
import com.skd.thesundering.client.render.entity.Thrown_Coral_Spear_Renderer;
import com.skd.thesundering.client.render.entity.Tidal_Hook_Renderer;
import com.skd.thesundering.client.render.entity.Tidal_Tentacle_Renderer;
import com.skd.thesundering.client.render.entity.Urchin_Spike_Renderer;
import com.skd.thesundering.client.render.entity.Urchinkin_Renderer;
import com.skd.thesundering.client.render.entity.Void_Howitzer_Renderer;
import com.skd.thesundering.client.render.entity.Void_Rune_Renderer;
import com.skd.thesundering.client.render.entity.Void_Scatter_Arrow_Renderer;
import com.skd.thesundering.client.render.entity.Void_Vortex_Renderer;
import com.skd.thesundering.client.render.entity.Wadjet_Renderer;
import com.skd.thesundering.client.render.entity.Water_Spear_Renderer;
import com.skd.thesundering.client.render.entity.Wave_Renderer;
import com.skd.thesundering.client.render.entity.Wither_Homing_Missile_Renderer;
import com.skd.thesundering.client.render.entity.Wither_Howitzer_Renderer;
import com.skd.thesundering.client.render.entity.Wither_Missile_Renderer;
import com.skd.thesundering.client.render.etc.CurioHeadRenderer;
import com.skd.thesundering.client.render.item.CuriosRenderer.Belt_Of_Beginner_Renderer;
import com.skd.thesundering.client.render.item.CuriosRenderer.Belt_Of_Monstrosity_Renderer;
import com.skd.thesundering.client.render.item.CuriosRenderer.Berserker_Soul_Amulet_Renderer;
import com.skd.thesundering.client.render.item.CuriosRenderer.Blazing_Grips_Renderer;
import com.skd.thesundering.client.render.item.CuriosRenderer.Chitin_Claw_Renderer;
import com.skd.thesundering.client.render.item.CuriosRenderer.Sticky_Gloves_Renderer;
import com.skd.thesundering.client.render.item.CuriosRenderer.Sturdy_Boots_Renderer;
import com.skd.thesundering.client.render.item.CuriosRenderer.Unbreakable_Skull_Renderer;
import com.skd.thesundering.client.render.item.CuriosRenderer.Vitality_Ankh_Renderer;
import com.skd.thesundering.client.render.item.CustomArmorRenderProperties;
