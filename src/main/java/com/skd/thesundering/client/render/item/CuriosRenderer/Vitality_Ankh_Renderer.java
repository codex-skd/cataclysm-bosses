...
public class Vitality_Ankh_Renderer
implements ICurioRenderer.HumanoidRender {
    private final Vitality_Ankh_Model model = new Vitality_Ankh_Model(Minecraft.getInstance().getEntityModels().bakeLayer(CMModelLayers.VITALITY_ANKH_MODEL));
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath((String)"cataclysm", (String)"textures/curiositem/vitality_ankh.png");

    @Override
    public Vitality_Ankh_Model getModel(ItemStack stack, SlotContext slotContext) {
        return this.model;
    }
