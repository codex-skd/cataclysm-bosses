...
import com.skd.thesundering.client.render.layer.LayerDeepling_WarlockItem;
...
extends MobRenderer<Deepling_Warlock_Entity, Deepling_Warlock_Model> {
    ...
    public Deepling_Warlock_Renderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, (EntityModel)new Deepling_Warlock_Model(), 0.7f);
        this.addLayer(new AbstractDeepling_Layer(this, DEEPLING_LAYER_TEXTURES));
        this.addLayer(new LayerDeepling_WarlockItem((RenderLayerParent)this, renderManagerIn.getItemInHandRenderer()));
    }
