...
public class Unbreakable_Skull_Renderer
implements ICurioRenderer.HumanoidRender {
    private final Unbreakable_Skull_Model model = new Unbreakable_Skull_Model(Minecraft.getInstance().getEntityModels().bakeLayer(CMModelLayers.UNBREAKABLE_SKULL_MODEL));
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath((String)"cataclysm", (String)"textures/curiositem/unbreakable_skull2.png");

    @Override
    public Unbreakable_Skull_Model getModel(ItemStack stack, SlotContext slotContext) {
        return this.model;
    }
