...
import com.skd.thesundering.client.render.etc.LightningBoltData;
import com.skd.thesundering.client.render.etc.LightningRender;
...
extends Particle {
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float partialTick) {
        ...
        LightningBoltData.BoltRenderInfo lightningBoltData = new LightningBoltData.BoltRenderInfo(0.5f, 0.1f, 0.5f, 0.85f, new Vector4f(this.rCol / 255.0f, this.gCol / 255.0f, this.bCol / 255.0f, (1.0f - ageProgress) * 0.8f), 0.1f);
        LightningBoltData bolt = new LightningBoltData(lightningBoltData, Vec3.ZERO, new Vec3(this.toX, this.toY, this.toZ), 4).size(0.05f).lifespan(this.lifetime).spawn(LightningBoltData.SpawnFunction.CONSECUTIVE);
    ...
    implements ParticleProvider<LightningParticleOptions> {
        public Particle createParticle(LightningParticleOptions data, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
