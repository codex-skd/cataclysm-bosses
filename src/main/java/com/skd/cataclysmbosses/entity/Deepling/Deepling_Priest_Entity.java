...
extends AbstractDeepling {
    ...
    public static boolean candeeplingSpawn(EntityType<? extends Deepling_Priest_Entity> guardian, LevelAccessor level, SpawnReason spawnType, BlockPos pos, RandomSource random) {
