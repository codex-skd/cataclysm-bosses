...
implements ItemSupplier {
    private static final EntityDataAccessor<ItemStack> DATA_ITEM_STACK = SynchedEntityData.defineId(Eye_Of_Dungeon_Entity.class, (EntityDataSerializer)EntityDataSerializers.ITEM_STACK);
    private static final EntityDataAccessor<Integer> R = SynchedEntityData.defineId(Eye_Of_Dungeon_Entity.class, (EntityDataSerializer)EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> G = SynchedEntityData.defineId(Eye_Of_Dungeon_Entity.class, (EntityDataSerializer)EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> B = SynchedEntityData.defineId(Eye_Of_Dungeon_Entity.class, (EntityDataSerializer)EntityDataSerializers.INT);
    private double tx;
    private double ty;
    private double tz;
    private int life;
    ...
    public Eye_Of_Dungeon_Entity(Level p_36960_, double p_36961_, double p_36962_, double p_36963_) {
        this((EntityType<? extends Eye_Of_Dungeon_Entity>)((EntityType)ModEntities.EYE_OF_DUNGEON.get()), p_36960_);
    ...
    public void lerpMotion(double p_36984_, double p_36985_, double p_36986_) {
        ...
        if (this.xRotO == 0.0f && this.yRotO == 0.0f) {
            ...
            this.setYRot((float)(Mth.atan2((double)p_36984_, (double)p_36986_) * 57.2957763671875));
            this.setXRot((float)(Mth.atan2((double)p_36985_, (double)d0) * 57.2957763671875));
    ...
    public void tick() {
        if (this.getItem().isEmpty()) {
            ...
            this.setXRot(Eye_Of_Dungeon_Entity.lerpRotation(this.xRotO, (float)(Mth.atan2((double)vec3.y, (double)d3) * 57.2957763671875)));
            this.setYRot(Eye_Of_Dungeon_Entity.lerpRotation(this.yRotO, (float)(Mth.atan2((double)vec3.x, (double)vec3.z) * 57.2957763671875)));
    ...
    private ItemStack getDefaultItem() {
        return new ItemStack((ItemLike)ModItems.DESERT_EYE.get());
    }
