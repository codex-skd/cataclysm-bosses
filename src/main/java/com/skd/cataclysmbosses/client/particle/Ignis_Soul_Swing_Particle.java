...
extends Abstract_Ignis_Swing_Particle {
    ...
    implements ParticleProvider<IgnisSoulSwingParticleOptions> {
        ...
        public Particle createParticle(IgnisSoulSwingParticleOptions options, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, RandomSource random) {
