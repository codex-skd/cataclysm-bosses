...
extends Particle {
    ...
    implements ParticleProvider<SparkTrailParticleOptions> {
        public Particle createParticle(SparkTrailParticleOptions data, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, RandomSource random) {
