...
extends AdvancedEntityModel<Endermaptera_Entity> {
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.root, this.head, this.body, this.abdomen, this.left_antenna, this.right_antenna, this.left_jaw, this.right_jaw, this.left_leg_front, this.right_leg_front, this.left_leg_mid, this.right_leg_mid, this.left_leg_back, this.right_leg_back);
    }
