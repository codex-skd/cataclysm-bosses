...
extends AdvancedEntityModel<Ender_Golem_Entity> {
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.root, this.left_arm, this.right_arm, this.left_arm2, this.right_arm2, this.left_finger, this.right_finger, this.left_leg, this.right_leg, this.head, this.lowerbody, this.upperbody, this.voidstone);
    }
