...
implements BlockEntityRenderer<Statue_Block_Entity, BlockEntityRenderState> {
    
    public Goddess_Statue_Renderer(BlockEntityRendererProvider.Context context) {
    ...
    @Override
    public void extractRenderState(Statue_Block_Entity blockEntity, BlockEntityRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
