...
implements BlockEntityRenderer<Abyssal_Egg_Block_Entity, BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(Abyssal_Egg_Block_Entity blockEntity, BlockEntityRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
