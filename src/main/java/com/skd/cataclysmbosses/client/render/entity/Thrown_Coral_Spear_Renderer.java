...
public class Thrown_Coral_Spear_Renderer
extends CmEntityRenderer<ThrownCoral_Spear_Entity> {
    private static final Identifier VOID_HOWITZER_TEXTURES = Identifier.fromNamespaceAndPath((String)"cataclysm", (String)"textures/entity/coral_spear.png");
    private final Coral_Spear_Model model = new Coral_Spear_Model();

    public Thrown_Coral_Spear_Renderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn);
    }

    protected void render(ThrownCoral_Spear_Entity entityIn, float partialTicks, PoseStack matrixStackIn, CmMultiBufferSource bufferIn, int packedLightIn) {
    ...
    public Identifier getTextureLocation(ThrownCoral_Spear_Entity entity) {
