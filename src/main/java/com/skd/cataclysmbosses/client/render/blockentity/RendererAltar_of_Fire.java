...
@OnlyIn(Dist.CLIENT)
public class RendererAltar_of_Fire
implements BlockEntityRenderer<AltarOfFire_Block_Entity, BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(AltarOfFire_Block_Entity blockEntity, BlockEntityRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
