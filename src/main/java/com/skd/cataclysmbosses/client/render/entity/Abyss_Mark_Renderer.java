...
extends CmEntityRenderer<Abyss_Mark_Entity> {
    ...
    protected void render(Abyss_Mark_Entity flameStrike, float delta, PoseStack matrixStackIn, CmMultiBufferSource bufferIn, int packedLightIn) {
