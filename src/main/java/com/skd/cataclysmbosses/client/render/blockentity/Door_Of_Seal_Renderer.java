...
implements BlockEntityRenderer<Door_Of_Seal_BlockEntity, BlockEntityRenderState> {
    
    public Door_Of_Seal_Renderer(BlockEntityRendererProvider.Context context) {
    ...
    @Override
    public void extractRenderState(Door_Of_Seal_BlockEntity blockEntity, BlockEntityRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
