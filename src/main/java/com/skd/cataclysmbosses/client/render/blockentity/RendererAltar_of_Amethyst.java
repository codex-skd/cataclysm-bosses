...
implements BlockEntityRenderer<AltarOfAmethyst_Block_Entity, BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(AltarOfAmethyst_Block_Entity blockEntity, BlockEntityRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
