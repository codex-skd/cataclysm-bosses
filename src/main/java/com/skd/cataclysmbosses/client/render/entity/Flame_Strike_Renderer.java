...
extends CmEntityRenderer<Flame_Strike_Entity> {
    ...
    protected void render(Flame_Strike_Entity flameStrike, float delta, PoseStack matrixStackIn, CmMultiBufferSource bufferIn, int packedLightIn) {
