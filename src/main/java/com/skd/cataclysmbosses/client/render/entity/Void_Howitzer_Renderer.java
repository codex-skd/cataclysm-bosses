...
import com.skd.cataclysmbosses.client.model.entity.Void_Howitzer_Model;
...
extends CmEntityRenderer<Void_Howitzer_Entity> {
    ...
    public Void_Howitzer_Renderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn);
    }

    protected void render(Void_Howitzer_Entity entityIn, float partialTicks, PoseStack matrixStackIn, CmMultiBufferSource bufferIn, int packedLightIn) {
    ...
    public Identifier getTextureLocation(Void_Howitzer_Entity entity) {
