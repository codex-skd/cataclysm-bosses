...
import com.skd.cataclysmbosses.client.model.entity.Ignis_Fireball_Model;
...
extends CmEntityRenderer<Ignis_Fireball_Entity> {
    ...
    protected void render(Ignis_Fireball_Entity entityIn, float partialTicks, PoseStack matrixStackIn, CmMultiBufferSource bufferIn, int packedLightIn) {
    ...
    public Identifier getTextureLocation(Ignis_Fireball_Entity entity) {
