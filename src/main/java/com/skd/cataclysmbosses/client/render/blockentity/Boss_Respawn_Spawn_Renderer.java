...
implements BlockEntityRenderer<Boss_Respawn_Spawner_Block_Entity, BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(Boss_Respawn_Spawner_Block_Entity blockEntity, BlockEntityRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
