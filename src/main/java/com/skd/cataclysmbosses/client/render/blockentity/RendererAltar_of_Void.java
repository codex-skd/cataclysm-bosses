...
@OnlyIn(Dist.CLIENT)
public class RendererAltar_of_Void
implements BlockEntityRenderer<AltarOfVoid_Block_Entity, BlockEntityRenderState> {
    
    public RendererAltar_of_Void(BlockEntityRendererProvider.Context context) {
    ...
    @Override
    public void extractRenderState(AltarOfVoid_Block_Entity blockEntity, BlockEntityRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
