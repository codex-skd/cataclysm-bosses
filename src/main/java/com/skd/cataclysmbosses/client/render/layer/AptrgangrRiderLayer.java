...
public class AptrgangrRiderLayer
extends RenderLayer<Aptrgangr_Entity, Aptrgangr_Model> {
    public AptrgangrRiderLayer(Aptrgangr_Renderer render) {
        super((RenderLayerParent)render);
    }

    public void render(PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn, Aptrgangr_Entity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity.isVehicle()) {
            ...
            for (Entity passenger : entity.getPassengers()) {
                ...
                AptrgangrRiderLayer.renderPassenger(passenger, 0.0, 0.0, 0.0, 0.0f, partialTicks, poseStack, bufferIn, packedLightIn);
                poseStack.popPose();
    ...
    public Vec3 getRiderPosition(Vec3 offsetIn) {
        ...
        ((Aptrgangr_Model)this.getParentModel()).translateToHand(translationStack);
