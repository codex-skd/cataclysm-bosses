...
public class ModDataAttachments {
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<Boolean>> HOOK_FALLING = ATTACHMENT_TYPES.register("hook_falling", () -> AttachmentType.builder(() -> false).serialize((MapCodec<Boolean>)Codec.BOOL).build());
