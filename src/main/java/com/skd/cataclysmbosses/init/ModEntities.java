...
public class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Ender_Guardian_Entity>> ENDER_GUARDIAN = ENTITY_TYPE.register("ender_guardian", () -> EntityType.Builder.of(Ender_Guardian_Entity::new, (MobCategory)MobCategory.MONSTER).sized(2.5f, 3.8f).fireImmune().clientTrackingRange(10).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("cataclysm", "ender_guardian"))));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Lava_Bomb_Entity>> LAVA_BOMB = ENTITY_TYPE.register("lava_bomb", () -> EntityType.Builder.of(Lava_Bomb_Entity::new, (MobCategory)MobCategory.MISC).sized(0.5f, 0.5f).fireImmune().setUpdateInterval(1).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("cataclysm", "lava_bomb"))));
    public static final DeferredHolder<EntityType<?>, EntityType<Flare_Bomb_Entity>> FLARE_BOMB = ENTITY_TYPE.register("flare_bomb", () -> EntityType.Builder.of(Flare_Bomb_Entity::new, (MobCategory)MobCategory.MISC).sized(0.5f, 0.5f).fireImmune().setUpdateInterval(1).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("cataclysm", "flare_bomb"))));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Ender_Guardian_Bullet_Entity>> ENDER_GUARDIAN_BULLET = ENTITY_TYPE.register("ender_guardian_bullet", () -> EntityType.Builder.of(Ender_Guardian_Bullet_Entity::new, (MobCategory)MobCategory.MISC).sized(0.3125f, 0.3125f).setUpdateInterval(1).setTrackingRange(64).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("cataclysm", "ender_guardian_bullet"))));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<The_Leviathan_Entity>> THE_LEVIATHAN = ENTITY_TYPE.register("the_leviathan", () -> EntityType.Builder.of(The_Leviathan_Entity::new, (MobCategory)MobCategory.MONSTER).sized(4.5f, 3.0f).fireImmune().eyeHeight(1.35f).clientTrackingRange(10).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("cataclysm", "the_leviathan"))));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Void_Howitzer_Entity>> VOID_HOWITZER = ENTITY_TYPE.register("void_howitzer", () -> EntityType.Builder.of(Void_Howitzer_Entity::new, (MobCategory)MobCategory.MISC).sized(0.5f, 0.5f).fireImmune().setUpdateInterval(1).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("cataclysm", "void_howitzer"))));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EarthQuake_Entity>> EARTHQUAKE = ENTITY_TYPE.register("earthquake", () -> EntityType.Builder.of(EarthQuake_Entity::new, (MobCategory)MobCategory.MISC).setTrackingRange(20).setUpdateInterval(1).sized(0.5f, 0.5f).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("cataclysm", "earthquake"))));
    public static final DeferredHolder<EntityType<?>, EntityType<Amethyst_Cluster_Projectile_Entity>> AMETHYST_CLUSTER_PROJECTILE = ENTITY_TYPE.register("amethyst_cluster_projectile", () -> EntityType.Builder.of(Amethyst_Cluster_Projectile_Entity::new, (MobCategory)MobCategory.MISC).sized(0.5f, 0.0f).fireImmune().setUpdateInterval(1).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("cataclysm", "amethyst_cluster_projectile"))));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Sandstorm_Projectile>> SANDSTORM_PROJECTILE = ENTITY_TYPE.register("sandstorm_projectile", () -> EntityType.Builder.of(Sandstorm_Projectile::new, (MobCategory)MobCategory.MISC).sized(0.5f, 1.0f).clientTrackingRange(4).setUpdateInterval(2).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("cataclysm", "sandstorm_projectile"))));
    public static final DeferredHolder<EntityType<?>, EntityType<Cursed_Sandstorm_Entity>> CURSED_SANDSTORM = ENTITY_TYPE.register("cursed_sandstorm", () -> EntityType.Builder.of(Cursed_Sandstorm_Entity::new, (MobCategory)MobCategory.MISC).sized(0.5f, 1.0f).setUpdateInterval(2).setTrackingRange(20).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("cataclysm", "cursed_sandstorm"))));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Maledictus_Entity>> MALEDICTUS = ENTITY_TYPE.register("maledictus", () -> EntityType.Builder.of(Maledictus_Entity::new, (MobCategory)MobCategory.MONSTER).sized(1.5f, 3.0f).fireImmune().clientTrackingRange(10).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("cataclysm", "maledictus"))));
