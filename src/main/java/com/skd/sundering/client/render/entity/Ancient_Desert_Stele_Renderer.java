...
import com.skd.sundering.client.model.entity.Ancient_Desert_Stele_Model;
...
extends EntityRenderer<Ancient_Desert_Stele_Entity> {
    ...
    public void render(Ancient_Desert_Stele_Entity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        VertexConsumer vertexconsumer = bufferIn.getBuffer(RenderType.entityTranslucent((Identifier)this.getTextureLocation(entityIn)));
        int maxWarmUp = 10;
        ...
        int i = FastColor.ARGB32.color((int)((int)(255.0f * alpha)), (int)r, (int)g, (int)b);
