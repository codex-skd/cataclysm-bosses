...
public class Kobolediator_Layer
extends RenderLayer<Kobolediator_Entity, Kobolediator_Model> {
    private static final Identifier LAYER_TEXTURES = Identifier.fromNamespaceAndPath((String)"cataclysm", (String)"textures/entity/koboleton/kobolediator_layer.png");
