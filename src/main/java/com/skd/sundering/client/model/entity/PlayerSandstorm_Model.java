...
public class PlayerSandstorm_Model
extends AdvancedEntityModel<LivingEntity> {
    ...
    public PlayerSandstorm_Model() {
        ...
        this.storm = new AdvancedModelBox((AdvancedEntityModel)this);
        ...
        this.storm2 = new AdvancedModelBox((AdvancedEntityModel)this);
        ...
        this.storm3 = new AdvancedModelBox((AdvancedEntityModel)this);
        ...
        this.storm4 = new AdvancedModelBox((AdvancedEntityModel)this);
    ...
    public void setupAnim(LivingEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.storm2.rotateAngleY -= this.storm.rotateAngleY + ageInTicks * 0.5f;
        this.storm3.rotateAngleY -= this.storm.rotateAngleY + this.storm2.rotateAngleY + ageInTicks * 0.3f;
        this.storm4.rotateAngleY -= this.storm.rotateAngleY + this.storm2.rotateAngleY + this.storm3.rotateAngleY + ageInTicks * 0.6f;
    }
