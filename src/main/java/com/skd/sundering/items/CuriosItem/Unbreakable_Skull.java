...
public class Unbreakable_Skull
extends CuriosItem {
    public Unbreakable_Skull(Item.Properties group) {
        super(group);
    }
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flags) {
        tooltip.add((Component)Component.translatable((String)"item.cataclysm.unbreakable_skull.desc").withStyle(ChatFormatting.DARK_GREEN));
    }
}
