...
public class Blazing_Grips
extends CuriosItem {
    public Blazing_Grips(Item.Properties group) {
        super(group);
    }
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltips, TooltipFlag flags) {
        tooltips.add((Component)Component.translatable((String)"item.cataclysm.blazing_grips.desc").withStyle(ChatFormatting.DARK_GREEN));
    }
}
